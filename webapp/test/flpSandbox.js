		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5BarCodeReader",
									"targetURL": "#UI5BarCodeReader-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"UI5BarCodeReader-display": {
								"semanticObject": "UI5BarCodeReader",
								"action": "display",
								"description": "UI5BarCodeReader",
								"title": "UI5BarCodeReader",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=barcodereader.barcodereader",
									"url": sap.ui.require.toUrl("barcodereader/barcodereader")
								}
							}
						}
					}
